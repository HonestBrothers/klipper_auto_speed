...
class AutoSpeed:
    def __init__(self, config):
        ...
        self.isolate_xy = self.printer_kinematics == 'cartesian' or self.printer_kinematics == 'limited_cartesian' or self.printer_kinematics == 'corexz' or self.printer_kinematics == 'limited_corexz'
